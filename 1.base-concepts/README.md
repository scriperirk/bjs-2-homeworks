...
Банку «Капитал Кэпиталс» потребовалось написать калькулятор для расчёта выплат по ипотеке, и они решили поручить эту задачу вам. 
...
**4.** Откройте файл `index.html` в вашем браузере и с помощью консоли `DevTools` убедитесь, что выводятся правильные результаты. <br>
